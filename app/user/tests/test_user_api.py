...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short(self):
        """Test that the password must be more thn 5 characters"""
    ...
    def test_create_token_with_invalid_email(self):
        """Test that the token is not created for invalid email"""
        create_user(email='test@gmail.com', password='testpass')
        payload = {'email': 'wrong@gmail.com', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
